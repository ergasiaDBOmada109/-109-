...
-- Δημιουργούμε ένα προσωρινό πίνακα
...
-- Εισάγουμε στον πίνακα participations τα δεδομένα του προηγούμενου πίνακα
INSERT INTO participations (recipe_number, episode_number)
SELECT random_value_1, random_value_2
FROM temp_random_values;

-- Σβήνουμε τον προσωρινό πίνακα 
DROP TEMPORARY TABLE IF EXISTS temp_random_values;
